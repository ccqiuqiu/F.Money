...
public class TagContainerLayout extends ViewGroup {
    ...
    public void setOnTagDragListener(OnTagDragListener l){
        mOnTagDragListener = l;
    }
    ...
    private void onChangeView(View view, int newPos, int originPos){
        ...
        addView(view, newPos);
        if(mOnTagDragListener != null && newPos != originPos){
            mOnTagDragListener.onDrag(originPos,newPos);
        }
    }
