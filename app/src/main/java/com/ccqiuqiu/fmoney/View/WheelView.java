            ...
            for (int i = 0; i < itemList.size(); i++) {
                if (itemList.get(i).isSelected()) {
                    ...
                    if (onSelectListener != null){
                        ...
                        msg.arg1 = itemList.get(i).id;
                        msg.obj = itemList.get(i).itemText;
                        msg.what = 9;
...
//                                itemList.get(i).itemText);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case REFRESH_VIEW:
                    ...
                    break;
                case 9:
                    onSelectListener.endSelect(msg.arg1, (String) msg.obj);
                    break;
                default:
                    noEmpty();
                    break;
    ...
    public void setDefaultText(String text) {
        setDefault(dataList.indexOf(text));
    }
