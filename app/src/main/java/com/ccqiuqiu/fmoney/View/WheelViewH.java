package com.ccqiuqiu.fmoney.View;
 ...
 */
public class WheelViewH extends View implements GestureDetector.OnGestureListener {
    ...
    public WheelViewH(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public WheelViewH(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(AttributeSet attrs) {
        ...
        mIntervalFactor = Math.max(0.9f, mIntervalFactor);
...
//		mCenterIndicatorPath.moveTo(mMaxOverScrollDistance - sizeDiv2 + getScrollX(), sizeDiv2);
//		mCenterIndicatorPath.rLineTo(sizeDiv2, -sizeDiv2);
//		mCenterIndicatorPath.rLineTo(sizeDiv2, sizeDiv2);
//		mCenterIndicatorPath.rLineTo(0, sizeDiv3);
//		mCenterIndicatorPath.rLineTo(-sizeDiv2, sizeDiv2);
...
//				}
            ...
            if (mMarkCount > 0 && i >= 0 && i < mMarkCount) {
                ...
                if (mCenterIndex == i) {
                    ...
                    if (!TextUtils.isEmpty(mAdditionCenterMark)) {
                        ...
                        canvas.drawText(temp, 0, temp.length(), x - off, mTopSpace + markHeight + ViewUtils.dp2px(5), mMarkTextPaint);
                        mMarkTextPaint.setTextSize(mNormalTextSize);
                        canvas.drawText(mAdditionCenterMark, x + tsize / 2f, mTopSpace + markHeight + ViewUtils.dp2px(5), mMarkTextPaint);
                    } else {
                        canvas.drawText(temp, 0, temp.length(), x, mTopSpace + markHeight + ViewUtils.dp2px(5), mMarkTextPaint);
    ...
    public interface OnWheelItemSelectedListener {
        void onWheelItemChanged(WheelViewH wheelView, int position);

        void onWheelItemSelected(WheelViewH wheelView, int position);
    }
