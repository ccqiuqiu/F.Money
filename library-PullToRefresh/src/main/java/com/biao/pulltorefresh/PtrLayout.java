...
public class PtrLayout extends ViewGroup {
    ...
    private boolean mIsHideDown,mIsHideUp;
    ...
    protected void onFinishInflate() {
        ...
        mHeaderView = new PtrViewHolder(this);
        mContentView = new PtrViewHolder(this);
        mFooterView = new PtrViewHolder(this);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mContentView.canScrollAndIsNotOriginalLocation()) {
                    ...
                    if (mDistanceY > 0 && mIsHideDown) {
                        return false;
                    }
                    if (mDistanceY < 0 && mIsHideUp) {
                        return false;
                    }
...
//            //ptrViewHolder.getView().getLayoutParams().height = ptrViewHolder.getView().getHeight()+distanceY;
//            ptrViewHolder.getView().requestLayout();
        }
    }
    ...
    public void setPullDown(boolean f){
        mIsHideDown = !f;
    }
    public void setPullUp(boolean f){
        mIsHideUp = !f;
    }
}
